# -*- coding: utf-8 -*-
"""
Created on Wed Feb 17 12:42:49 2016
...
# Funcion: abrirImagen
# Parametros: Ninguno
# Descripcion: en esta funcion se leen las carpetas contenidas en la carpeta "trainingSet"
...
def abrirImagen():
    ...
    for x in range(0,10): # for para recorrer cada carpeta
        ...
        #print ("**",clase)
        direc="trainingSet/arialSegmented/"+str(clase)+"/" #ubicación de las carpetas del 0-9
        ...
        for i in range(0,imagenes): #for para recorrer cada imagen
            ...
            #la imagen existe, para la extraccion de atributos
                ...
                ###Conseguir Valores de Atributos###
...
#Variables de retorno: linea de tipo string qu contiene todos los datos de la nueva instancia, 
